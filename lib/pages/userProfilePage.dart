...
class _UserProfilePageState extends ConsumerState<UserProfilePage>
  ...
  Future getMyPosts() async {
    try {
      myposts = await FirebaseFirestore.instance
          .collection("Posts")
          .where("postBy", isEqualTo: FirebaseAuth.instance.currentUser!.uid)
          .get();
    } catch (e) {
      print(e);
    }
                ...
                return CustomScrollView(slivers: [
                  SliverPersistentHeader(
                    delegate: CustomSliverDelegate("",
                        expandedHeight: 200,
                        profileimg: snapshot.data['image'] ?? ""),
                  ),
                  SliverToBoxAdapter(
                    child: Column(
                      children: [
